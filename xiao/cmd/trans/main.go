...
func main() {
	...
	fullBright := make([]color.RGBA, xiao.NumLEDs)
	drawTransFlag(fullBright[xiao.BackLEDs[0]:xiao.BackLEDs[1]])

	currentBright := make([]color.RGBA, xiao.NumLEDs)
